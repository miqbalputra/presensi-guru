...
function AIAgent() {
  ...
  const checkConnection = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE}/v1/integrations/hermes`, {
        method: 'GET',
        headers: {
  ...
  const endpoints = [
    {
      method: 'GET',
      path: '/api/v1/integrations/hermes',
    ...
    {
      method: 'GET',
      path: '/api/v1/integrations/hermes/overview',
    ...
    {
      method: 'GET',
      path: '/api/v1/integrations/hermes/attendance',
    ...
    {
      method: 'GET',
      path: '/api/v1/integrations/n8n/users',
    ...
    {
      method: 'GET',
      path: '/api/v1/integrations/n8n/attendance',
    ...
    {
      method: 'GET',
      path: '/api/v1/integrations/n8n/missing-attendance',
    ...
    {
      method: 'POST',
      path: '/api/v1/integrations/n8n/activity',
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-3 bg-gray-50 rounded-lg">
              ...
              <p className="text-xs text-gray-500">
                Dipakai oleh: <code className="font-mono">/api/v1/integrations/hermes/*</code><br/>
            ...
            <div className="p-3 bg-gray-50 rounded-lg">
              ...
              <p className="text-xs text-gray-500">
                Dipakai oleh: <code className="font-mono">/api/v1/integrations/n8n/*</code><br/>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-bold text-gray-700">/api/v1/integrations/webhook</span>
              </div>
              <p className="text-xs text-gray-500">
            ...
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center gap-2 mb-1">
                <Send className="w-4 h-4 text-gray-600" />
                <span className="text-sm font-bold text-gray-700">/api/v1/integrations/webhook/direct</span>
              </div>
              <p className="text-xs text-gray-500">
