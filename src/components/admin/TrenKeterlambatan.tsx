...
const computeStats = (logs, startStr, endStr) => {
  ...
  return (Object.values(byDate) as any[]).map(r => ({
    ...r,
...
function TrenKeterlambatan() {
  ...
  const [statsA, setStatsA] = useState<any>({ hadir: 0, terlambat: 0, tidakHadir: 0, pctTerlambat: '0.0', pctHadir: '0.0', avgMins: null })
  const [statsB, setStatsB] = useState<any>({ hadir: 0, terlambat: 0, tidakHadir: 0, pctTerlambat: '0.0', pctHadir: '0.0', avgMins: null })
